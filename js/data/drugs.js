const drugsData = [
    { 
        ...
        ku: { name: "پاراسیتامۆڵ", cat: "ئازارشکێن", desc: "یەکێکە لە باوترین و سەلامەتترین دەرمانەکان بۆ کەمکردنەوەی ئازار و دابەزاندنی پلەی گەرمیی لەش. بەکارهێنانە سەرەکییەکان: کەمکردنەوەی ئازار (سەر، ددان، ماسولکەکان، سووڕی مانگانە، پشت) وە دابەزاندنی تا لە کاتی پەتا و ئەنفلۆنزا.", dose: "پێگەیشتووان: 500 بۆ 1000 ملگم بۆ هەر ژەمێک (نابێت لە 4000 ملگم زیاتر بێت لە 24 کاتژمێردا). منداڵان: بەپێی کێش و تەمەن. نێوانی ژەمەکان بە لایەنی کەمەوە 4 بۆ 6 کاتژمێر بێت.", warn: "ژەهراویبوونی جگەر مەترسیدارترین لایەنیەتی بەهۆی زیادەڕۆییەوە. پێویستە ئاگاداری دەرمانە تێکەڵەکانی تری پەتا بیت کە پاراستامۆڵیان تێدایە. بۆ نەخۆشییەکانی جگەر و گورچیلە ڕاوێژ بکە.", side: "پەیوەندی بە پزیشکەوە بکە ئەگەر: ئازار 3 بۆ 5 ڕۆژ، یان تا زیاتر لە 3 ڕۆژ بەردەوام بوو، یان نیشانەی هەستیاری دەرکەوت. لە کاتی زیادخواردنی بە هەڵە دەستبەجێ بڕۆ فریاکەوتن.", benefit: "تێبینی: ئەم زانیارییانە بۆ مەبەستی ڕۆشنبیرییە و جێگەی ڕاوێژی پزیشکی ناگرێتەوە. هەمیشە پێش بەکارهێنان سەیری ڕێنماییەکانی ناو پاکەتەکە بکە." }, 
