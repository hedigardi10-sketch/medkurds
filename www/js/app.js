...
const AI_SYSTEM_PROMPT = `تۆ پزیشکێکی پسپۆڕ و زیرەکی و تەنها وەڵامی پرسیاری پزیشکی و تەندروستی دەدەیتەوە. 
...
function loadFromFirestore() {
    ...
    const collections = ['drugs', 'nursing', 'emergency', 'nutrition', 'skincare', 'dictionary', 'body', 'lab', 'vitamins', 'equipment', 'maternal', 'vaccinations', 'hotlines', 'herbal', 'poisoning', 'diseases', 'occupational', 'signlanguage', 'pathology', 'bloodTypes'];
...
function getFavoritesData() {
    const categories = ['drugs', 'nursing', 'emergency', 'body', 'lab', 'vitamins', 'equipment', 'nutrition', 'skincare', 'maternal', 'herbal', 'poisoning', 'dictionary', 'diseases', 'occupational', 'signlanguage', 'pathology', 'bloodTypes'];
    let allData = [];
...
function showIntroduction() {
    ...
    let introContent = `
        <div style="text-align: ${alignment}; line-height: 1.8; color: #fff;">
            <h2 style="color: var(--primary); text-align: center; margin-bottom: 20px;"><i class="fas fa-book-medical"></i> ${trans.introduction}</h2>
