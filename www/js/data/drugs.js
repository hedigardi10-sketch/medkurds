const drugsData = [
    { 
        ...
        ku: { name: "پاراسیتامۆڵ", cat: "ئازارشکێن", desc: "بۆ چارەسەری ئازار و دابەزاندنی تا.", dose: "٥٠٠ملگم بۆ ١٠٠٠ملگم هەموو ٤ بۆ ٦ کاتژمێر جارێک (بەپێی پێویست).", warn: "نابێت لە ٤ گرام (٤٠٠٠ملگم) زیاتر بخورێت لە ڕۆژێکدا، چونکە زیان بە جەرگ دەگەیەنێت.", side: "هێڵنجدان، ئازاری گەدە، و هەندێک جار پەڵەی پێست.", benefit: "کەمکردنەوەی ئازاری سەر، ددان، جومگەکان و دابەزاندنی پلەی گەرمی لەش." }, 
